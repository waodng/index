...
function sskadmin(e) {
	...
	else if(e.user_id === undefined){
        if (checkMobile()) {
            ssk = '<span class="ua"><span class="sskadmin">游客</span></span><br><br>';
        } else {
            ssk = '<span class="ua"><span class="sskadmin">游客</span></span>';
        }
    }
	else {
        if (checkMobile()) {
